...
export const AddToFavourite = payload => {
  return async dispatch => {
    let favproducts = await AjaxProviderLogged(
      '/favproducts?method=add&id_product=' +
        payload.id_product +
        '&id_product_attribute=' +
        payload.id_product_attribute,
    );
    console.log('AddToFavourite', favproducts);
    if (favproducts) dispatch(dispatchAddToFavourite(favproducts));
  };
};
...
export const removeFromFavourite = payload => {
  return async dispatch => {
    let favproducts = await AjaxProviderLogged(
      '/favproducts?method=remove&id_product=' +
        payload.id_product +
        '&id_product_attribute=' +
        payload.id_product_attribute,
    );
    console.log('removefavproducts:', favproducts);
    if (favproducts) dispatch(dispatchRemoveFromFavourite(favproducts));
  };
};
...
export const getFavList = () => {
  return async dispatch => {
    ...
    console.log('getFavList', favproducts);
    if (favproducts) dispatch(dispatchgetFavList(favproducts));
  };
};
